...
package demos.android.async.task.demo.databinding;
...
import demos.android.async.task.demo.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressBar,
      @NonNull TextView resultText, @NonNull Button startBtn) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, progressBar, resultText, startBtn);
    }
